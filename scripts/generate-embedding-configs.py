...
output_config["datasets"] = [d for d in output_config["datasets"] if d["key"] == args.dataset_key]
...
output_config["sklearn_experiment"] = {
        ...
        "data": {k: {split_k: exp_conf["data"][k][split_k] for split_k in ("split", "evaluate_metrics") if split_k in exp_conf["data"][k]} for k in ("train", "test")}}
